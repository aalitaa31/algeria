...
module.exports = {
    Isim: "permjail",
    Komut: ["kalıcıjail","rusyalıjail"],
    Kullanim: "kcezalı @rusyalı/ID <sebep>",
  ...
  onRequest: async function (client, message, args, guild) {
    ...
    if(!uye || !reason) return message.channel.send(`Hata: Lütfen üye belirleyin veya sebep belirleyin!  __Örn:__  \`${client.sistem.a_Prefix}permjail @rusyalı/ID <sebep>\``).then(x => x.delete({timeout: 5000}));
