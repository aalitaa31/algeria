...
module.exports = {
    Isim: "seskontrol",
    Komut: ["sesk"],
    Kullanim: "seskontrol @rusyalı/ID",
  ...
  onRequest: async (client, message, args) => {
    ...
    if(!uye) return message.channel.send(`Hata: Lütfen bir üye etiketleyin veya Id giriniz!  __Örn:__  \`${client.sistem.a_Prefix}seskontrol @rusyalı/ID\``).then(x => x.delete({timeout: 5000}));
