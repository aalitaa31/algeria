...
module.exports = {
    Isim: "uyar",
    Komut: ["uyarı","uyar"],
    Kullanim: "uyarı @ruyalı/ID <uyarı açıklaması>",
  ...
  onRequest: async function (client, message, args, guild) {
    ...
    if(!uye || !reason) return message.channel.send(`Hata: Lütfen bir üye etiketleyin veya Id girin!  __Örn:__  \`${client.sistem.a_Prefix}uyarı @rusyalı/ID <sebep>\``).then(x => x.delete({timeout: 5000}));
