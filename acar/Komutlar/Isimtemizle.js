...
module.exports = {
    Isim: "isimtemizle",
    Komut: ["it"],
    Kullanim: "isimtemizle @rusyalı/ID",
  ...
  onRequest: async function (client, message, args, guild) {
    ...
    if(!uye) return message.channel.send(`Hata: Lütfen bir üye etiketleyin veya Id giriniz!  __Örn:__  \`${client.sistem.a_Prefix}isimtemizle @rusyalı/ID\``).then(sil => sil.delete({timeout: 5000}));
