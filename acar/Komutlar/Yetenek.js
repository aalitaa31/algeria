...
module.exports = {
    Isim: "yetenek",
    Komut: ["yetenek"],
    Kullanim: "yetenek @rusyalı/ID <Yetenek İsmi>",
  ...
  onRequest: async function (client, message, args, guild) {
    ...
    if (!uye) return message.channel.send(`Hata: yetenek rolü verebilmem için lütfen bir üyeyi etiketle __Örn:__ \`${client.sistem.a_Prefix}${module.exports.Isim} @rusyalı/ID <Yetenek İsmi>\`!`).then(x => x.delete({timeout: 5000}));
    if(args[1] !== "vokal" && args[1] !== "Vokal" && 
