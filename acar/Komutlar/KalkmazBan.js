...
module.exports = {
  ...
  onRequest: async function (client, message, args) {
    ...
    let embed = new MessageEmbed().setColor('0x2f3136').setTitle(`Rusyalı Yargı Sistemi (v2.0)`).setAuthor(acar.Tag + " " + acar.sunucuIsmi, message.guild.iconURL({dynamic: true, size: 2048}))
    ...
    let ceza = {
        ...
        Tip: "BOTBAN",
        Tur: "KALKMAYAN BAN",
        BitisZaman: "Rusyalının Keyfine kalmış!",
        Sebep: reason,
        Zaman: Date.now() 
      };
    if(args[0] === "liste") {
